...
def validation(model, criterion, evaluation_loader, converter, opt):
    ...
    for i, (image_tensors, labels) in enumerate(evaluation_loader):
        ...
        im = tensor2im(image_tensors[3])
        save_image(im, "/home/fabian/Documents/Datachecker/AttentionHTR/model/TEST.png")
        print(image_tensors.shape)
        print(image_tensors[0].shape)
        img = cv2.imread("/home/fabian/Documents/Datachecker/AttentionHTR/model/TEST.png")
        
        img_og = image_tensors[3].cpu().float().numpy()
        ...
        image_tensors[3] = torch.tensor(img).float()
